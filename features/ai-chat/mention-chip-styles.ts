...
const MENTION_CHIP_BASE =
  "ai-composer-tag inline-flex max-w-[min(220px,100%)] cursor-default select-none items-center gap-0.5 rounded py-px align-baseline text-xs font-medium leading-none whitespace-nowrap"

function resolveMentionChipKind(
  type: AiTagType,
): "task" | "project" | "component" | "channel" | "user" | "neutral" {

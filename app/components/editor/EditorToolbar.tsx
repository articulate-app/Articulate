...
export const EditorToolbar: React.FC<EditorToolbarProps> = ({
  ...
  return (
    ...
    <div
      className={cn(
        "relative z-30 flex w-full flex-wrap items-center gap-0.5 overflow-y-visible border-b border-border bg-background/80 px-2 py-1.5 backdrop-blur",
        sticky && "sticky top-0",
        className
      )}
    >

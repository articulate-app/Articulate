...
import { AddExistingSupplierPaymentModal } from './AddExistingSupplierPaymentModal'
...
export function AddSupplierPaymentModal({ 
  invoiceId, 
  invoiceCurrency,
  invoiceNumber,
  payerTeamId,
  ...
  // If showing existing payment selection, render the AddExistingSupplierPaymentModal
  if (showExistingPayment) {
    return (
      <AddExistingSupplierPaymentModal
        invoiceId={invoiceId}

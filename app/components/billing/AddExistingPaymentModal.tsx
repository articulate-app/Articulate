...
interface AddExistingPaymentModalProps {
  invoiceId: number
...
export function AddExistingPaymentModal({ 
  invoiceId, 
  invoiceCurrency, 
  isOpen, 
  onClose, 
  ...
  const { data: payments, isLoading } = useQuery({
    queryKey: ['available-payments', searchTerm],
    queryFn: async () => {
      let query = supabase
      ...
      if (searchTerm) {
        query = query.or(`external_ref.ilike.%${searchTerm}%,payer_team_name.ilike.%${searchTerm}%`)
      }
        ...
        <div className="flex-1 overflow-hidden flex flex-col space-y-4">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                id="search"
                placeholder="Search by external reference or payer team..."
                value={searchTerm}
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-gray-500 mt-1">
                          {payment.payer_team_name} • {payment.method} • {new Date(payment.payment_date).toLocaleDateString()}
                        </div>
                      </div>

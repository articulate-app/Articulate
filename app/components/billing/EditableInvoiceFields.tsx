...
interface EditableInvoiceFieldsProps {
  invoice: any
  onInvoiceUpdate?: (updatedInvoice: any) => void
}

export function EditableInvoiceFields({ invoice, onInvoiceUpdate }: EditableInvoiceFieldsProps) {
  ...
  const handleFieldUpdate = async (field: string, value: string) => {
    try {
      ...
      updateInvoiceInCaches(queryClient, updatedInvoice)
  ...
  // Update team field (issuer or payer)
  ...
  return {
    ...
    externalInvoiceId: (
      <EditableTextField
        ...
        onSave={(value) => handleFieldUpdate('external_invoice_id', value)}
    ...
    // Renamed from "issuer" to "Supplier" for consistency
    supplier: (
      <EditableTeamField
    ...
    // Renamed from "invoice to" to "Payer" for consistency
    payer: (
      <EditableTeamField

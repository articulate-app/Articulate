...
export function ParentTaskSelect({ currentParentId, onChange, disabledIds = [], projectId }: ParentTaskSelectProps) {
  ...
  // Fetch the current parent task's title and type for display
  useEffect(() => {
    if (!currentParentId) {

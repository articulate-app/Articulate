...
export const RealtimeChat = ({
  ...
  return (
    <div className="flex flex-col h-full w-full bg-background text-foreground antialiased">
      {/* Messages */}
      <div ref={containerRef} className="flex-1 overflow-y-auto px-4 pt-2 pb-4">
      ...
      {!hideInput && (
        <form onSubmit={handleSendMessage} className="flex w-full flex-col gap-2 border-t border-border p-4">
          ...
          {replyTo ? (
            <div className="mb-2 flex items-start justify-between gap-3 rounded-md border bg-gray-50 px-3 py-2">

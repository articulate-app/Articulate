-- Expose per-day impressions (views) on the competitive summary timeseries so the
-- Competition chart can plot "Impressions over time" alongside interactions.
...
begin
  ...
  totals as (
    select
      ...
      sum(views_total)::bigint as views_total
